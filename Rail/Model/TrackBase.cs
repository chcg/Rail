    ...
    public abstract class TrackBase
    {
        ...
        protected Geometry CreateCurvedTrackGeometry(double angle, double radius)
        {
            ...
            return new PathGeometry(new PathFigureCollection
            {
                ...
                {
                    new LineSegment(circleCenter - PointExtentions.Circle(-angle / 2, radius + this.RailSpacing / 2), true),
                    new ArcSegment (circleCenter - PointExtentions.Circle(angle / 2, radius + this.RailSpacing / 2), outerSize, angle, false, SweepDirection.Counterclockwise, true),

                    new LineSegment(circleCenter - PointExtentions.Circle(angle / 2, radius - this.RailSpacing / 2), true),
                    new ArcSegment (circleCenter - PointExtentions.Circle(-angle / 2, radius - this.RailSpacing / 2), innerSize, angle, false, SweepDirection.Clockwise, true)
                }, true)
            });
        }
        ...
        protected Drawing StraitBallast(double length, StraitOrientation orientation = StraitOrientation.Center, double direction = 0, Point? pos = null)
        {
            ...
            Rectangle rec = new Rectangle(x, -this.RailSpacing, length, this.RailSpacing * 2).Rotate(direction).Move(pos);
        ...
        {
            Size innerSize = new Size(radius - this.RailSpacing, radius - this.RailSpacing);
            Size outerSize = new Size(radius + this.RailSpacing, radius + this.RailSpacing);
            ...
            return new GeometryDrawing(ballastBrush, null,
                new PathGeometry(new PathFigureCollection
                {
                    new PathFigure(pos - new Vector(0, this.RailSpacing), new PathSegmentCollection
                        {
                            new LineSegment((pos + new Vector(0, this.RailSpacing)), true),
                            new ArcSegment ((pos + new Vector(0, this.RailSpacing)).Rotate(angl, circleCenter), innerSize, angle, false, swdA, true),

                            new LineSegment((pos - new Vector(0, this.RailSpacing)).Rotate(angl, circleCenter), true),
                            new ArcSegment ((pos - new Vector(0, this.RailSpacing)), outerSize, angle, false, swdB, true),
                        }, true)
                }));
        }
        ...
        protected Drawing CurvedRail(double angle, double radius, Point pos, TrackDirection dir)
        {
            ...
            railDrawing.Children.Add(new GeometryDrawing(null, railPen, new PathGeometry(new PathFigureCollection
            {
                new PathFigure((pos - new Vector(0, this.RailSpacing / 2)), new PathSegmentCollection
                {
                    new ArcSegment ((pos - new Vector(0, this.RailSpacing / 2)).Rotate(angl, circleCenter), innerSize, angle, false, swdA, true)
                }, false)
            })));
            railDrawing.Children.Add(new GeometryDrawing(null, railPen, new PathGeometry(new PathFigureCollection
            {
